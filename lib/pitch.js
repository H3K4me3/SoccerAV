    ...
    draw_passpaths() {
        ...
        Promise.all([events, lineup]).then(function([events, lineup]) {
            ...
            pass_paths
                ...
                .attr("x1", d => scalePitchX(d.location[0]))
                .attr("y1", d => scalePitchY(d.location[1]))
                .attr("x2", d => scalePitchX(d.pass.end_location[0]))
                .attr("y2", d => scalePitchY(d.pass.end_location[1]))
